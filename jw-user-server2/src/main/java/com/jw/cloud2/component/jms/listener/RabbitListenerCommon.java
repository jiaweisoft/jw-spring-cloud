package com.jw.cloud2.component.jms.listener;
...
public class RabbitListenerCommon implements MessageListener {
    ...
    @RabbitListener(containerFactory = "containerFactoryCommon",
            bindings = {
                    @QueueBinding(value = @Queue(value = "jw.queue2.direct", durable = "true", autoDelete = "false"),
                            exchange = @Exchange(value = "jw.exchange2",
                                    durable = "true", autoDelete = "false", type = ExchangeTypes.DIRECT), key = "jw.k.direct2")})
